...
DATE_FROM_FIELDS = _to_locators(_raw["DATE_FROM_FIELDS"])
DATE_TO_FIELDS = _to_locators(_raw["DATE_TO_FIELDS"])
...
RESULT_ROWS = _to_locators(_raw["RESULT_ROWS"])
...
CUST_REFERENCE_INPUT = _to_locators(_raw["CUST_REFERENCE_INPUT"])
